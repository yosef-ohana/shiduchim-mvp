...
type AdminReportDetailsNavigationProp = NativeStackNavigationProp<AdminStackParamList, 'AdminReportDetails'>;
type AdminReportDetailsRouteProp = RouteProp<AdminStackParamList, 'AdminReportDetails'>;

...
public class StaffParticipantDetailsResponse {
    ...
    // manageable weddings
    private List<StaffParticipantWeddingResponse> manageableWeddings;

    // permissions
    private Boolean canAdminBlock;
    private Boolean canAdminUnblock;
    ...
    public List<StaffParticipantWeddingResponse> getManageableWeddings() { return manageableWeddings; }
    public void setManageableWeddings(List<StaffParticipantWeddingResponse> manageableWeddings) { this.manageableWeddings = manageableWeddings; }

    public Boolean getCanAdminBlock() { return canAdminBlock; }
    public void setCanAdminBlock(Boolean canAdminBlock) { this.canAdminBlock = canAdminBlock; }

    public Boolean getCanAdminUnblock() { return canAdminUnblock; }
    public void setCanAdminUnblock(Boolean canAdminUnblock) { this.canAdminUnblock = canAdminUnblock; }
}
